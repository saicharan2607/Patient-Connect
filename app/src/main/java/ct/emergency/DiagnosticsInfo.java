...
public class DiagnosticsInfo extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.diagnosticsinfo);
...
public void feedback(View view){
	...
	AlertDialog.Builder builder = new AlertDialog.Builder(DiagnosticsInfo.this);
	View layout= null;
	...
	builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
		public void onClick(DialogInterface dialog, int id) {
			...
			String selectQuery = "SELECT rating FROM diagnostic where name='" + pharnm + "' ";
			...
			db.execSQL("update diagnostic set rating=" + totrate + " where name='" + pharnm + "'");
