...
public class AddDiagnostic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adddiagnosis);
        setTitle("Add Diagnostic");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        db=openOrCreateDatabase("healthcare", MODE_PRIVATE,null);
        db.execSQL("create table if not exists diagnostic(name varchar,service varchar,address varchar,contact varchar,lat varchar,long varchar,rating varchar)");
    ...
    public void addpharmacy(View v){
        ...
        try {
            ...
            db.execSQL("insert into diagnostic values('" + name1 + "','" + servicevalue.getText().toString() + "','" + addr.getText().toString() + "','" + ph.getText().toString() + "','" + lat.getText().toString() + "','" + lon.getText().toString() + "',5) ");
