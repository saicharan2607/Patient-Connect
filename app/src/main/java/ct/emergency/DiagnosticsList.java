...
public class DiagnosticsList extends AppCompatActivity implements AdapterView.OnItemClickListener{
	// Log tag
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GPSTracker gps = new GPSTracker(DiagnosticsList.this);
		...
		mySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> adapterView, View view, int position, long itemID) {
				if (position >= 0 && position < categories.length) {
					...
					Toast.makeText(DiagnosticsList.this, "Selected Category Does not Exist!", Toast.LENGTH_SHORT).show();
				}
			}
	...
	private void getSelectedCategoryData(int categoryID) {
	 ...
	 sl = new ArrayList<>();
		...
		if(categoryID == 0)
		{idt=0;
			adapter = new CustomListAdapter2(DiagnosticsList.this, stdList);
		}
			...
			adapter = new CustomListAdapter2(DiagnosticsList.this, sl);
			...
			String selectQuery = "SELECT *FROM diagnostic order by rating DESC";
			...
			adapter = new CustomListAdapter2(DiagnosticsList.this, s2);
		}
	...
	class details extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog1 = new ProgressDialog(DiagnosticsList.this);
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				String selectQuery = "SELECT *FROM diagnostic";
				Cursor cursor = db.rawQuery(selectQuery, null);
				if (cursor != null) {
...
if(sts==0){
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent intent=new Intent(DiagnosticsList.this,DiagnosticsInfo.class);
